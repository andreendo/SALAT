...
public class WebAlertTest {
    ...
    public static void beforeClass() {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Bites\\Documents\\DriverSelenium\\chromedriver.exe");
    }
    ...
    public void after() {
     ...
     @Test
    public void testCriadorWeb() {
         Driver driver = new WebAlert(webDriver, "http://criadorweb.com.br/", "http://criadorweb.com");       
